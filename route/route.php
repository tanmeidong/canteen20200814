...
Route::post('api/:version/pos/getTotalRecords', 'api/:version.Pos/getTotalRecords');
Route::post('api/:version/pos/getStaffInfo', 'api/:version.Pos/getStaffInfo');
Route::post('api/:version/pos/getAccounts', 'api/:version.Pos/getAccounts');
...
Route::post('api/:version/pos/getCardInfo', 'api/:version.Pos/getCardInfo');
